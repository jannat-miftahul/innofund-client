...
const HomePage = () => {
    ...
    return (
        <div className="overflow-hidden">
            ...
            <section className="relative py-12 sm:py-16 md:py-24 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
                <FloatingParticles />

                {/* Background glow effects */}
                <div className="absolute top-1/4 left-1/4 w-48 sm:w-72 lg:w-96 h-48 sm:h-72 lg:h-96 bg-brightPink/20 rounded-full blur-3xl" />
                <div className="absolute bottom-1/4 right-1/4 w-48 sm:w-72 lg:w-96 h-48 sm:h-72 lg:h-96 bg-neonGreen/20 rounded-full blur-3xl" />

                <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Section Header */}
                    <div className="text-center mb-8 sm:mb-12 lg:mb-16">
                        <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm text-neonGreen text-xs sm:text-sm font-medium mb-3 sm:mb-4 border border-white/20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        {stats.map((stat, index) => (
                            ...
                            >
                                {/* Glassmorphism Card */}
                                <div className="relative backdrop-blur-xl bg-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-500 hover:scale-105 hover:shadow-neonGreen/20">
                                    {/* Glow effect on hover */}
                                    <div className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-r from-neonGreen/0 via-brightPink/0 to-softOrange/0 group-hover:from-neonGreen/10 group-hover:via-brightPink/10 group-hover:to-softOrange/10 transition-all duration-500" />

                                    <div className="relative z-10 text-center">
                                        {/* Icon */}
                                        <div
                                            className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 ${stat.iconBg} rounded-xl sm:rounded-2xl mb-4 sm:mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                                        >
                                            <stat.icon className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-white" />
                                        </div>

                                        {/* Value */}
                                        <h3 className="text-2xl sm:text-4xl lg:text-5xl font-bold text-white mb-1 sm:mb-2">
            ...
            >
                ...
                <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        <div className="group relative md:col-span-2 lg:col-span-1 lg:row-span-2 bg-gradient-to-br from-brightPink to-rose-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl shadow-brightPink/20 overflow-hidden">
                            ...
                            {/* Floating elements */}
                            <div className="absolute top-4 sm:top-6 right-4 sm:right-6 w-12 sm:w-20 h-12 sm:h-20 bg-white/10 rounded-xl sm:rounded-2xl rotate-12 group-hover:rotate-45 transition-transform duration-700" />
                            <div className="absolute bottom-6 sm:bottom-10 right-6 sm:right-10 w-10 sm:w-16 h-10 sm:h-16 bg-white/10 rounded-full group-hover:scale-150 transition-transform duration-700" />

                            <div className="relative z-10 h-full flex flex-col justify-between">
                                <div>
                                    <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl mb-4 sm:mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                                    ...
                                    <p className="text-white/80 text-sm sm:text-base lg:text-lg leading-relaxed mb-4 sm:mb-6">
                                        Enterprise-grade security protecting
                                        every donation with end-to-end encrypted
                                        payments and fraud detection.
                                    </p>
                                </div>

                                {/* Stats */}
                                <div className="flex items-center gap-4 sm:gap-6 pt-4 sm:pt-6 border-t border-white/20">
                                    <div>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <div className="inline-flex items-center justify-center w-11 h-11 sm:w-14 sm:h-14 bg-gradient-to-br from-neonGreen to-green-600 rounded-xl sm:rounded-2xl mb-4 sm:mb-6 shadow-lg shadow-neonGreen/30 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                                ...
                                <div className="flex -space-x-2">
                                    ...
                                    <span className="inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-neonGreen text-[10px] sm:text-xs font-bold text-white border-2 border-white">
                                        +145
                                    </span>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <div className="inline-flex items-center justify-center w-11 h-11 sm:w-14 sm:h-14 bg-gradient-to-br from-softOrange to-orange-500 rounded-xl sm:rounded-2xl mb-4 sm:mb-6 shadow-lg shadow-softOrange/30 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                        ...
                        {/* Feature Card 4 - Wide */}
                        <div className="group relative lg:col-span-2 bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl overflow-hidden">
                            {/* Animated gradient orbs */}
                            <div className="absolute top-0 right-0 w-32 sm:w-48 lg:w-64 h-32 sm:h-48 lg:h-64 bg-brightPink/20 rounded-full blur-3xl group-hover:bg-brightPink/30 transition-colors duration-700" />
                            <div className="absolute bottom-0 left-0 w-24 sm:w-36 lg:w-48 h-24 sm:h-36 lg:h-48 bg-neonGreen/20 rounded-full blur-3xl group-hover:bg-neonGreen/30 transition-colors duration-700" />

                            <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-8">
                                <div className="flex-1">
                                    <div className="inline-flex items-center gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-neonGreen/20 text-neonGreen text-xs sm:text-sm font-medium mb-3 sm:mb-4">
                                    ...
                                    <p className="text-gray-400 text-sm sm:text-base lg:text-lg leading-relaxed">
                                        Our dedicated team is always here to
                                        help you succeed. Get assistance
                                        whenever you need it.
                                    </p>
                                </div>

                                {/* Support stats */}
                                <div className="flex flex-row sm:flex-col gap-6 sm:gap-4 w-full sm:w-auto">
                                    ...
                                    <div className="text-center sm:text-right flex-1 sm:flex-auto">
                                        <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-neonGreen">
                                            98%
                                        </p>
                                        <p className="text-gray-500 text-xs sm:text-sm">
                                            Satisfaction
                    ...
                    <div className="mt-10 sm:mt-16 text-center">
                        <Link
                            to="/about"
                            className="group inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-brightPink to-softOrange text-white font-semibold rounded-full shadow-lg shadow-brightPink/30 hover:shadow-xl hover:shadow-brightPink/40 hover:scale-105 transition-all duration-300 text-sm sm:text-base"
                        >
            ...
            <section className="relative py-12 sm:py-20 lg:py-28 overflow-hidden">
                ...
                {/* Floating shapes */}
                <div className="absolute top-6 sm:top-10 left-6 sm:left-10 w-16 sm:w-24 lg:w-32 h-16 sm:h-24 lg:h-32 bg-white/10 rounded-full blur-xl animate-pulse" />
                <div className="absolute bottom-6 sm:bottom-10 right-6 sm:right-10 w-20 sm:w-32 lg:w-40 h-20 sm:h-32 lg:h-40 bg-neonGreen/20 rounded-full blur-xl animate-pulse" />
                <div className="absolute top-1/2 right-1/4 w-12 sm:w-18 lg:w-24 h-12 sm:h-18 lg:h-24 bg-white/10 rounded-full blur-2xl hidden sm:block" />

                <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    {/* Badge */}
                    <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/20 backdrop-blur-sm text-white text-xs sm:text-sm font-medium mb-4 sm:mb-6 border border-white/30">
                        🚀 Start Today
                    </span>
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
                        ...
                        <span className="relative inline-block">
                            ...
                            <span className="absolute -bottom-1 sm:-bottom-2 left-0 w-full h-2 sm:h-3 bg-neonGreen/50 rounded-full -rotate-1" />
                        </span>
                        ?
                    </h2>

                    <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-white/90 mb-6 sm:mb-8 lg:mb-10 max-w-3xl mx-auto leading-relaxed px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
                        <Link
                            to="/add-campaign"
                            className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 bg-neonGreen text-gray-900 hover:bg-lime-400 w-full sm:w-auto px-6 sm:px-8 lg:px-10 py-3 sm:py-4 text-base sm:text-lg font-bold rounded-full shadow-2xl hover:shadow-neonGreen/50 transition-all duration-300 hover:scale-105 overflow-hidden"
                        >
                        ...
                        <Link
                            to="/all-campaigns"
                            className="group inline-flex items-center justify-center gap-2 sm:gap-3 bg-transparent border-2 border-white text-white hover:bg-white hover:text-brightPink w-full sm:w-auto px-6 sm:px-8 lg:px-10 py-3 sm:py-4 text-base sm:text-lg font-bold rounded-full transition-all duration-300 hover:scale-105"
                        >
            ...
            >
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 w-32 sm:w-48 lg:w-64 h-32 sm:h-48 lg:h-64 bg-neonGreen/20 rounded-full blur-3xl" />

                        <div className="relative z-10 text-center max-w-2xl mx-auto">
                            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">
                                Stay in the Loop
                            </h3>
                            <p className="text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base lg:text-lg px-2">
                                Get the latest updates on new campaigns, success
                                stories, and exclusive tips delivered to your
                                inbox.
                            </p>
                            ...
                            <form className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                                <input
                                    ...
                                    className="flex-1 max-w-md px-4 sm:px-6 py-3 sm:py-4 rounded-full bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-neonGreen focus:ring-2 focus:ring-neonGreen/20 transition-all duration-300 text-sm sm:text-base"
                                />
                                <button
                                    type="submit"
                                    className="px-6 sm:px-8 py-3 sm:py-4 bg-neonGreen hover:bg-lime-400 text-gray-900 font-bold rounded-full shadow-lg hover:shadow-neonGreen/30 transition-all duration-300 hover:scale-105 text-sm sm:text-base"
                                >
                                    Subscribe
                                </button>
                            </form>
