...
const Signin = () => {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            {/* Animated Background */}
            <div className={`absolute inset-0 ${isDark ? "bg-gradient-to-br from-darkBg via-darkCard to-darkBg" : "bg-gradient-to-br from-lightPurple via-white to-lightPink"}`} />

            {/* Floating Decorative Elements */}
            <div className={`absolute top-20 left-10 w-72 h-72 rounded-full blur-3xl animate-pulse ${isDark ? "bg-gradient-to-br from-brightPink/10 to-softOrange/10" : "bg-gradient-to-br from-brightPink/20 to-softOrange/20"}`} />
            <div className={`absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl animate-pulse ${isDark ? "bg-gradient-to-br from-neonGreen/10 to-skyBlue/15" : "bg-gradient-to-br from-neonGreen/20 to-skyBlue/30"}`} style={{ animationDelay: "1s" }} />
            <div className={`absolute top-1/2 left-1/3 w-64 h-64 rounded-full blur-3xl animate-pulse ${isDark ? "bg-gradient-to-br from-softOrange/10 to-paleYellow/15" : "bg-gradient-to-br from-softOrange/20 to-paleYellow/30"}`} style={{ animationDelay: "2s" }} />
            ...
            <div className="relative max-w-screen-xl mx-auto min-h-screen flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="relative group">
                        ...
                        <div className={`relative backdrop-blur-xl rounded-3xl border shadow-2xl p-8 sm:p-10 ${isDark ? "bg-darkCard/70 border-darkBorder" : "bg-white/70 border-white/50"}`}>
                            {/* Form Header */}
                            <div className="text-center mb-8">
                                ...
                                <h2 className={`text-2xl font-bold mb-2 ${isDark ? "text-white" : "text-gray-800"}`}>Welcome Back!</h2>
                                <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-500"}`}>Enter your credentials to access your account</p>
                            </div>
